 ...
 * @author Josema
 */
@WebServlet(name = "MainControlador", urlPatterns = {""})
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet CafeControlador</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet CafeControlador at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
            boolean isLoggedIn = false;
            if(request.getSession().getAttribute("email_empleado") != null){
                isLoggedIn = true;
            }
            ...
            try {
                ...
                ArrayList cafes = cafemodelo.getAllCafe();
